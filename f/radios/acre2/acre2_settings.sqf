...
f_radios_settings_acre2_languages = [["postapoc","Postapocalypicese"]];

// defines the language that a player can speak.
// can define multiple
f_radios_settings_acre2_language_blufor = ["postapoc"];
f_radios_settings_acre2_language_opfor = ["postapoc"];
f_radios_settings_acre2_language_indfor = ["postapoc"];
